...
const MCPServersPanel = () => {
    ...
    const [newKeyScopeMode, setNewKeyScopeMode] = useState<ApiKeyScopeMode>('read_write');
    ...
    const createKey = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                alert(data.error || 'No se pudo crear la API key.');
            }
        } catch (e) { console.error(e); }
        ...
        <div className="space-y-8 animate-fadeIn">
            ...
            {showCreateModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    <div className="absolute inset-0 backdrop-blur-sm bg-black/50" onClick={closeCreateModal} />
                    <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}
                        ...
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <button onClick={closeCreateModal} className="p-1 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"><Icons.X /></button>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                                    ...
                                    <button type="button" onClick={() => setNewKeyScopeMode('read_write')}
                                        ...
                                        <span className="block text-sm font-semibold">Lectura y escritura</span>
                                        <span className="block text-[11px] opacity-50 mt-0.5">GET y POST: crear o actualizar</span>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="flex gap-3 mt-6">
                            <button onClick={closeCreateModal} className="flex-1 py-2.5 rounded-xl font-medium bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 transition-colors text-sm">
                                Cancelar
                            </button>
